...
SUBSCRIPTION_PLANS = {
    ...
    "monthly": {
        ...
        "amount_paise": int(os.getenv("PLAN_MONTHLY_PAISE", "34900")),
        "original_amount_paise": int(os.getenv("PLAN_MONTHLY_ORIGINAL_PAISE", "34900")),
        "discount_label": "",
        "recommended": False,
    },
    "yearly": {
        ...
        "amount_paise": int(os.getenv("PLAN_YEARLY_PAISE", "44900")),
        "original_amount_paise": int(os.getenv("PLAN_YEARLY_ORIGINAL_PAISE", "44900")),
        "discount_label": "90% OFF",
        "recommended": True,
    },
}
